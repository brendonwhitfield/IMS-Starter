...
import com.qa.ims.controller.OrderContentsController;
...
public class IMS {
	...
	public IMS() {
		...
		final OrderContentDAO orcoDAO = new OrderContentDAO();
		this.orderContents = new OrderContentsController(orcoDAO, utils);
	}
